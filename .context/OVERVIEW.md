...
## Core Features
1.  **Global Industry Database**: Scrapes industry mappings from `/market/` and caches them locally (~3,100 stocks). The cache now self-heals if local storage is empty but old metadata still exists.
